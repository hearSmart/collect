...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
    ...
    private void loadForm() {
        ...
        if (data instanceof FormLoaderTask) {
            ...
            Log.d(TAG, "instanceof FormLoaderTask");
        } else if (data instanceof SaveToDiskTask) {
            saveToDiskTask = (SaveToDiskTask) data;
            Log.d(TAG, "instanceof SaveToDiskTask");
        } else if (data == null) {
            Log.d(TAG, "instanceof data == null");
            if (!newForm) {
                Log.d(TAG, "!newForm");
                if (getFormController() != null) {
                    Log.d(TAG, "getFormController() != null");
                    refreshCurrentView();
                } else {
                    Log.d(TAG, "getFormController() == null");
